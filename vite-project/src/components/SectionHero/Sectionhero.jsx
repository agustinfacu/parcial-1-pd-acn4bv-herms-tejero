...
// Iconos SVG internos
// ----------------------------------------------------------------------------
// • Se incluyen como componentes para poder pasarlos por props.
// ============================================================================
const PrinterIcon = () => (
  <svg
    width="30"
...
// ----------------------------------------------------------------------------
// • Define el contenido textual (title, subtitle, lead) y el array de features.
// • Ensambla el CTA(boton de accion) principal y la fila de features.
// • Envuelve todo dentro de <main> y <section> para semántica clara.
// ============================================================================
...
const SectionHero = () => {
  ...
  // --------------------------------------------------------------------------
  // Datos de features (íconos + texto)
  // • Se pasan a <HeroFeaturesRow /> para renderizado con .map()
  // • Cada ítem tiene role="listitem" en el subcomponente.
  // --------------------------------------------------------------------------
  const features = [
  ...
  return (
    <main>
      {/* 
        Section con referencia accesible al título principal (aria-labelledby).
      */}
      <section className="hero wrap" aria-labelledby="hero-title">
        ...
        {/* 
          CTA principal 
          - role="group": agrupa acciones.
          - <HeroCTA /> recibe href, label e icon para mantener 1:1 tu botón.
        */}
        ...
        {/* 
          Fila de iconos/características:
          - <HeroFeaturesRow /> recibe un array de features y los mapea.
          - Encapsula role="list" y cada item role="listitem".
        */}
